...
//#endregion
//#region node_modules/meyda/dist/web/meyda.min.js
var require_meyda_min = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(r, t) {
		...
		function c(t, e, a, n, o, i, u) {
			...
			}), 1).concat([1]), h = Math.round(t / 2), g = new Array(t).fill(0).map((function(r, e) {
		...
		function p(r) {
			...
			for (var n = m({ ampSpectrum: t }), o = e.length, i = Array(o), u = new Float32Array(o), f = 0; f < u.length; f++) {
		...
		var g = null;
		var w = h((function(r, t) {
			var e = r.length;
			return t = t || 2, g && g[e] || function(r) {
				(g = g || {})[r] = new Array(r * r);
				for (var t = Math.PI / r, e = 0; e < r; e++) for (var a = 0; a < r; a++) g[r][a + e * r] = Math.cos(t * (a + .5) * e);
			}(e), r.map((function() {
				return 0;
			})).map((function(a, n) {
				return t * r.reduce((function(r, t, a, o) {
					return r + t * g[e][a + n * e];
				}), 0);
			}));
		}));
		var v = Object.freeze({
		...
		var y = {}, S = {}, _ = {
			bitReverseArray: function(r) {
				if (void 0 === y[r]) {
					for (var t = (r - 1).toString(2).length, e = "0".repeat(t), a = {}, n = 0; n < r; n++) {
						var o = n.toString(2);
						o = e.substr(o.length) + o, o = [].concat(d(o)).reverse().join(""), a[n] = parseInt(o, 2);
					}
					y[r] = a;
				}
				return y[r];
			...
			constructComplexArray: function(r) {
				...
				var e = t.real.length;
				return void 0 === S[e] && (S[e] = Array.apply(null, Array(e)).map(Number.prototype.valueOf, 0)), t.imag = S[e].slice(), t;
			}
		}, b = function(r) {
			var t = {};
			...
			for (var n = _.bitReverseArray(e), o = {
				real: [],
				imag: []
			}, i = 0; i < e; i++) o.real[n[i]] = t.real[i], o.imag[n[i]] = t.imag[i];
			for (var u = 0; u < e; u++) t.real[u] = o.real[u], t.imag[u] = o.imag[u];
			for (var f = 1; f <= a; f++) for (var c = Math.pow(2, f), l = 0; l < c / 2; l++) for (var s = _.euler(l, c), m = 0; m < e / c; m++) {
				var p = c * m + l, h = c * m + l + c / 2, g = {
					...
					real: t.real[h],
					imag: t.imag[h]
				}, v = _.multiply(s, w), d = _.subtract(g, v);
			...
			windowing: n,
			_errors: {
				notPow2: /* @__PURE__ */ new Error("Meyda: Buffer size must be a power of 2, e.g. 64 or 512"),
				featureUndef: /* @__PURE__ */ new Error("Meyda: No features defined."),
				invalidFeatureFmt: /* @__PURE__ */ new Error("Meyda: Invalid feature format"),
				invalidInput: /* @__PURE__ */ new Error("Meyda: Invalid input."),
				noAC: /* @__PURE__ */ new Error("Meyda: No AudioContext specified."),
				noSource: /* @__PURE__ */ new Error("Meyda: No source node specified.")
			},
			createMeydaAnalyzer: function(r) {
				return new F(r, Object.assign({}, A));
			},
			...
			var a = {};
			void 0 === r.buffer ? a.signal = i(r) : a.signal = r, a.windowedSignal = n(a.signal, t), a.complexSpectrum = M(a.windowedSignal), a.ampSpectrum = new Float32Array(e / 2);
